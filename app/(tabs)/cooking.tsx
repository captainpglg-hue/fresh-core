...
import { Flame, Timer, ThermometerSun } from 'lucide-react-native';
...
export default function CookingScreen() {
  ...
  const { cookingRecords, activeTimers, addCookingRecord, startCoolingTimer, addCoolingCheckpoint, loadRecords } = useCookingStore();
